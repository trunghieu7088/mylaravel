          ...
          <div class="col-lg-6">
            ...
            <div class="card card-primary">
              ...
              <!-- form start -->
                  ...
                  <form method="POST" enctype="multipart/form-data" id="comicjaxform">
                @csrf
                <div class="card-body">
                ...
                <div class="card-footer">
                   <button type="submit" id="AddComicbtnAjax" name="AddComic" class="btn btn-primary">Add Comic</button>
